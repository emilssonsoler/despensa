 ...
 */
public class GestionEmpleadoPorHora {
    private LinkedList<EmpleadoPorHora> listaEmleado = new LinkedList<>();
     ...
     * @return
     */
    public boolean modificarEmpleadoByIndice(int indiceEmpleado, EmpleadoPorHora EmpleadoModificado) {
     ...
     * @return 
     */
    public boolean modificarEmpleado(int codigoEpleadoAmodificar, EmpleadoPorHora empleadoModificado) {
     ...
     */
    public boolean modificarEmpleado(String nombreEmpleadoAmodificar, EmpleadoPorHora empleadoModificado) {
